...
import { getCommunityPosts, createCommunityPost, addReactionToPost, addCommentToPost, updateCommunityPost, deleteCommunityPost, deleteCommentFromPost, addReactionToComment, getCommunityPostById } from '../services/api';
                ...
                >
                    <div className="flex flex-col" style={{height: '70vh'}}>
                        ...
                        <div className="p-4 border-b border-marrom-seiva/10 dark:border-creme-velado/10 flex-shrink-0">
                            <div className="flex items-start">
                                <img src={viewingCommentsFor.isAnonymous || !viewingCommentsFor.author ? ANONYMOUS_AVATAR : viewingCommentsFor.author.avatarUrl} alt="author" className="w-10 h-10 rounded-full object-cover mr-3"/>
                                <div>
